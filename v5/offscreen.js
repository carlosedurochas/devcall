// v5: STT = Moonshine-base | Diarização = CAM++ (3D-Speaker)
// Combinação teto de qualidade no browser sem Whisper nem wespeaker/resnet.
// Requer lib/sherpa/cam_pp.onnx — veja instruções em lib/sherpa/diarization.js.
...
async function diarizeAudio(audio) {
  status("Carregando diarizacao (CAM++)...");
