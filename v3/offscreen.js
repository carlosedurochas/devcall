// v3: STT = Moonshine-base | Diarização = wespeaker-resnet34
// Moonshine-base oferece melhor qualidade que tiny mantendo vantagem de velocidade
// sobre o Whisper. Não aceita `language` nem `task` (específicos do Whisper).
